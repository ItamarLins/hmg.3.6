...
HB_FUNC (BT_DRAW_HDC_FILLEDOBJECT)
{
   ...
   INT nWidthLine, nType, RoundWidth ,RoundHeight;
...
HB_FUNC (BT_DRAW_HDC_TEXTOUT)
{
   ...
   if ((nType & BT_TEXT_TRANSPARENT) == BT_TEXT_TRANSPARENT)
   ...
   if ((nType & BT_TEXT_BOLD) == BT_TEXT_BOLD)
       Bold = FW_BOLD;
   
   if ((nType & BT_TEXT_ITALIC) == BT_TEXT_ITALIC)    
       Italic = 1;
   
   if ((nType & BT_TEXT_UNDERLINE) == BT_TEXT_UNDERLINE)       
       Underline = 1;
       
   if ((nType & BT_TEXT_STRIKEOUT) == BT_TEXT_STRIKEOUT)    
       StrikeOut = 1;
